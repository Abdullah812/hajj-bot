...
const ADMIN_IDS = [
    123456789, // رقم تعريف الأدمن الأول
                    ...
                    if (isAdmin(userId)) {
                        ...
                        if (allReports.length === 0) {
                            ...
                            await bot.sendMessage(
                                ...
                                `🔄 قيد المعا��جة: ${processingReports}\n` +
